<?php
// Require the common functions file and database configuration file
...
// Check if a student ID has been passed through the URL, and delete the corresponding student from the database
if(isset($_GET['id'])) {
    $id = $_GET['id'];
...
<body>
  ...
  <div class="home-content" >
    <div class="title">STUDENT'S ATTENDANCE</div>
      <div class="attendance box">
        <a href="export-attendance.php"> <button type="button" class="btn btn-primary">Export</button></a>
            <table class="table table-striped">
                <thead class="thead-dark">
                    <tr>
                        <th scope="col">Name</th>
