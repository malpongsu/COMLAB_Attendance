...
if(isset($_POST['cancel'])) {
  header("Location: ../admin_page/admin_accounts.php");
  exit();
}
?>
    ...
    <form method="post">
      ...
      <div class="form-group">
        ...
        <button type="submit" name="submit" class="btn btn-primary">Update</button>
          <button type="cancel" name="cancel" class="btn btn-secondary" onclick = href='../admin_page/admin_students_rfid_info.php?id=5'">Cancel</button>
    </form>
  </div>
</div>
</body>
